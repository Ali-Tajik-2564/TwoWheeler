    ...
    return (
        <div>
            <div className='w-[95%] mx-auto p-1 text-right'>
                <h1 className="text-xl font-semibold text-mainPrimary w-full border-b border-mainPrimaryLight pb-3">جدید ترین کاربران</h1>
            ...
            <div className='w-[95%] mx-auto p-1 text-right'>
                <h1 className="text-xl font-semibold text-mainPrimary w-full border-b border-mainPrimaryLight pb-3">جدید ترین تخفیف ها</h1>
                <table className='w-full my-4 '>
                    <thead>
                        <tr className='p-3 text-lg font-medium text-mainPrimary flex justify-between items-center flex-row-reverse border-b-2 mb-3'>
                            <td>نام محصول</td>
